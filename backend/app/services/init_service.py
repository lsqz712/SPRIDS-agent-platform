...
class InitService:
    ...
    @staticmethod
    def _seed_defect_types(db: Session) -> int:
        """启动时自动插入 6 种 PCB 缺陷类型（幂等）"""
        from app.entity.db_models import DefectType
        from app.entity.defect_types import DEFECT_TYPES
    ...
    def init_all(db: Session) -> dict:
        ...
        for step_name, step_fn in [
            ...
            ("defect_types", InitService._seed_defect_types),
