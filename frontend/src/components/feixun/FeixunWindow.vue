...
.feixun-window-resize-north__hit {
  ...
  stroke-width: 12;
  pointer-events: stroke;
  @include phro-cursor.phro-cursor-resize-ns;
  touch-action: none;
...
.window-resize-handle {
  ...
  &--nw {
    ...
    z-index: 27;
    @include phro-cursor.phro-cursor-resize-nwse;
  }
  ...
  &--ne {
    ...
    height: $phro-resize-corner;
    z-index: 27;
    @include phro-cursor.phro-cursor-resize-nesw;
  }
  ...
  &--e {
    ...
    @include phro-cursor.phro-cursor-resize-ew;
  }
...
.chat-panel {
  @include phro-panel-sections;
  flex: 1;
  @include phro-cursor.phro-cursor-default;
}
